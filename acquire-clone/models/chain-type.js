...
/*-----------------------------------------------------------------------------
  chain schema
-----------------------------------------------------------------------------*/
var ChainType = new mongoose.Schema({
	chainName: String,
	chainColor: String,
	numStock: Number,
	...
	{collection: 'chain-types'});

/*-----------------------------------------------------------------------------
  get stock price
-----------------------------------------------------------------------------*/
ChainType.methods.getStockPrice = function(x, callback) {
...
/*-----------------------------------------------------------------------------
  get majority bonus
-----------------------------------------------------------------------------*/
ChainType.methods.getMajorityBonus = function(x, callback) {
...
/*-----------------------------------------------------------------------------
  get minority bonus
-----------------------------------------------------------------------------*/
ChainType.methods.getMinorityBonus = function(x, callback) {
...
/*-----------------------------------------------------------------------------
  lookup value
-----------------------------------------------------------------------------*/
ChainType.methods.lookupVal = function(x, xt, yt, callback) {
...
/*-----------------------------------------------------------------------------
  export model
-----------------------------------------------------------------------------*/
module.exports = mongoose.model('ChainType', ChainType);
